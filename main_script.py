...
#fp_platf = flt.pass_filepath(r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_insitu\platfCSV_hs")
fp_platf = flt.pass_filepath(r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_insitu\platfCSV_wind")
fp_sat = r"D:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_Sat_csv\S6a\cmems_obs-wave_glo_phy-swh_nrt_s6a-l3_PT1S_1720457544714.csv"
start='2021-01-01'
end='2024-01-01'
...
for cross_r in cross_radius:
    ...
    time_cross = []
    number_data = []
    # r"D:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_sat_csv"
    # r"D:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_sat_csv_wspd"
    # r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_sat_csv_single"
    for fp_sat in flt.pass_filepath(r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_sat_csv_single"):
        ...
        fig.savefig(r"C:\Users\eduar\Desktop\screen Tesi\prova" + "\\" + nome + "_wspd_60min.png", dpi=dpi)
        # -------------------------------------------------------------------------------------------------------------
        """

        outPut_sat = r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_output_codice\Ds_vavh_2" + "\\" + nome + ".csv"
        outPut_insitu = r"E:\Materiale_Uni\Tesi_Magsitrale\Dataset\Dataset_output_codice\Ds_vavh_2" + "\\" + nome + "_insitu" + ".csv"
    ...
    dataframe_finale.to_csv(r"C:\Users\eduar\Desktop\dataframe_analysis" + str(counter) + ".csv")
    counter = counter + 1
